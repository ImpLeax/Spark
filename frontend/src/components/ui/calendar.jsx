...
// 1. ДОДАНО: ChevronsLeftIcon та ChevronsRightIcon для року
import { ChevronLeftIcon, ChevronRightIcon, ChevronDownIcon, ChevronsLeftIcon, ChevronsRightIcon } from "lucide-react"
...
function Calendar({
  ...
  formatters,
  components,
  // 2. ДОДАНО: пропси для керування датою ззовні
  month,
  defaultMonth,
  onMonthChange,
  ...props
  ...
  // 3. ДОДАНО: Логіка зміни року
  const [currentMonth, setCurrentMonth] = React.useState(defaultMonth || month || new Date());
  ...
  return (
    // 4. ДОДАНО: Відносна обгортка (relative) для позиціонування наших кнопок
    <div className="relative w-fit">
      
      {/* 5. ДОДАНО: Кнопки року. Відступ px-8 акуратно розміщує їх поруч з кнопками місяця */}
      ...
      <DayPicker
        month={displayMonth} // Передаємо наш контрольований місяць
        onMonthChange={handleMonthChange} // Обробник зміни
