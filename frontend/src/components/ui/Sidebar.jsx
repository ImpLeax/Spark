...
const Sidebar = ({ render, isCollapsed, setIsCollapsed }) => {
  ...
  const menuItems = [
    { name: "Discover", path: "/recommendations", icon: <Search size={22} /> },
    { name: "Messages", path: "/messages", icon: <MessageCircle size={22} /> },
...
if (render === false || isExiting) return null;
  ...
  return (
      ...
      <div className="p-4 border-t border-border mt-auto shrink-0 pb-safe">
        <button
